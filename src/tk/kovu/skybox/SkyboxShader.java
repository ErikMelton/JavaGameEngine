...
{
    private static final String VERTEX_FILE = "src/tk/kovu/skybox/skyboxVertexShader.txt";
    private static final String FRAGMENT_FILE = "src/tk/kovu/skybox/skyboxFragmentShader.txt";
